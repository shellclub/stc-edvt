...
<head>
    ...
    <style>
        ...
        .table tbody td { padding: 18px 20px; vertical-align: middle; border-bottom: 1px solid #f8f8f8; }
        ...
        /* สไตล์เพิ่มเติมสำหรับปุ่มดูวันเกิด */
    ...
    <div class="row">
        ...
        <div class="col-md-10 p-md-5 p-4">
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="bilateral_groups.php" class="text-decoration-none fw-bold" style="color:var(--primary)">กลุ่มการเรียน</a></li>
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr>
                                ...
                                <th>รหัสประจำตัว</th>
                                <th class="text-center">วันเกิด (ใช้ Reset รหัส)</th>
                                <th>สถานะล็อกอิน</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <!-- ปุ่มดูวันเกิด -->
                                    <button class="btn btn-info-user" 
                                            data-bs-toggle="modal" 
                                            data-bs-target="#modal<?php echo $row['student_id']; ?>"
                                            title="ดูวันเดือนปีเกิด">
                                        <i class="bi bi-calendar-event"></i>
                                    </button>

                                    <!-- Modal สำหรับแสดงข้อมูลวันเกิด -->
                                    <div class="modal fade" id="modal<?php echo $row['student_id']; ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                                                ...
                                                <div class="modal-body text-center pb-5">
                                                    ...
                                                    <h4 class="fw-bold"><?php echo $row['fullname']; ?></h4>
                                                    <p class="text-muted">รหัสนักศึกษา: <?php echo $row['student_id']; ?></p>
                                                    <hr class="mx-5">
                                                    <div class="py-2">
                                                        <span class="text-muted d-block small">วันเดือนปีเกิดในระบบ</span>
                                                        <h3 class="text-primary fw-bold"><?php echo ($row['birth_date'] != "" ? $row['birth_date'] : "ไม่พบข้อมูล"); ?></h3>
                                                    </div>
                                                    <small class="text-danger">* ใช้ข้อมูลนี้ในการยืนยันตัวตนเพื่อตั้งรหัสผ่านใหม่</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    // เปิดใช้งาน Tooltips ของ Bootstrap
